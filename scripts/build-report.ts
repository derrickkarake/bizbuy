...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  details.methodology {
    background: var(--card); border: 1px solid var(--border);
    border-radius: 8px; padding: .75rem 1rem; margin-top: 2rem;
  }
  details.methodology summary {
    cursor: pointer; font-weight: 600; font-size: 13px;
  }
  details.methodology ul { font-size: 13px; color: var(--text); margin: .5rem 0 0; }
...
<header>
  ...
  <div class="sub">Rubric v2 · ${records.length} listings · OK/TX/AR scrape + memo additions · generated ${new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</div>
</header>
...
<details class="methodology">
  <summary>Rubric v2 — how scores are calculated</summary>
  <ul>
    <li><b>Scheduling / route density (20)</b> — routes, territories, dispatch, maintenance agreements.</li>
    <li><b>Owner workload AI can replace (18)</b> — owner handles CSR/quoting/scheduling/estimates.</li>
    <li><b>Recurring / contract revenue (15)</b> — explicit recurring %, contracts, memberships.</li>
    <li><b>Size fit (10)</b> — SDE $100K–$400K, ask $150K–$1.5M, ≤15 employees.</li>
    <li><b>Price sanity vs regional multiple (8)</b> — OK ≤3.0x, DFW ≤2.85x.</li>
    <li><b>Margin headroom vs industry benchmark (12)</b> — pest 34%, cleaning 30%, HVAC 22%, etc.</li>
    <li><b>Absentee / manager-ready (10)</b> — owner-light, 1099 labor, home-based.</li>
    <li><b>License transferability (7)</b> — penalizes OK/TX regulated trades without qualifier path.</li>
    <li><b>Soft red flags (−5 each)</b> — customer concentration, tech-dependent, owner-as-face, inflated SDE.</li>
    <li><b>Hard DQ</b> — franchise, restaurant/medical/legal, ask &gt;$3M, SDE &lt;$50K.</li>
  </ul>
</details>
